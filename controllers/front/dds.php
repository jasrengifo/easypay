...
class easypayDdsModuleFrontController extends ModuleFrontController
{
    ...
    private function create_pago_simple()
    {
        ...
        if ($cat_valido != 1 && $productos_in != 1) {
            ...
            print('<div style="width: 100%; text-align: center; margin-top: 30px;"><div style="width: 90%; max-width: 900px; display: inline-block; padding: 10px 20px; background-color: rgba(247, 37, 22, .1); border: 1px solid rgb(247, 37, 22); border-radius: 5px;"><b>Erro: Para pagar com este metodo, só deves adicionar produtos de suscrição ao carrinho.</b></div><br><a style="color: black;" href="/index.php?controller=Order"><div style="padding: 10px 20px; margin-top: 30px; cursor: pointer; display: inline-block; background-color: #e8e8e8; border-radius: 20px;"><b>Corrigir</b></div></div></div>');
            die();
        }
        ...
        if ($tiene_la_feature != 1) {
            ...
            print('<div style="width: 100%; text-align: center; margin-top: 30px;"><div style="width: 90%; max-width: 900px; display: inline-block; padding: 10px 20px; background-color: rgba(247, 37, 22, .1); border: 1px solid rgb(247, 37, 22); border-radius: 5px;"><b>Erro: Para comprar este artigo deves contatar ao administrador. (Deve ser definido FREQUENCY no produto)</b></div><br><a style="color: black;" href="/index.php?controller=Order"><div style="padding: 10px 20px; margin-top: 30px; cursor: pointer; display: inline-block; background-color: #e8e8e8; border-radius: 20px;"><b>Corrigir</b></div></div></div>');
            die();
        }

        if ($tiene_exp_time != 1) {

            print('<div style="width: 100%; text-align: center; margin-top: 30px;"><div style="width: 90%; max-width: 900px; display: inline-block; padding: 10px 20px; background-color: rgba(247, 37, 22, .1); border: 1px solid rgb(247, 37, 22); border-radius: 5px;"><b>Erro: Para comprar este artigo deves contatar ao administrador. (Deve ser definido EXP_TIME no produto)</b></div><br><a style="color: black;" href="/index.php?controller=Order"><div style="padding: 10px 20px; margin-top: 30px; cursor: pointer; display: inline-block; background-color: #e8e8e8; border-radius: 20px;"><b>Corrigir</b></div></div></div>');
            die();
        }
        ...
        if ($expiration_final == '1D' or $expiration_final == '1W') {
            ...
            print('<div style="width: 100%; text-align: center; margin-top: 30px;"><div style="width: 90%; max-width: 900px; display: inline-block; padding: 10px 20px; background-color: rgba(247, 37, 22, .1); border: 1px solid rgb(247, 37, 22); border-radius: 5px;"><b>Erro: Para comprar este artigo deves contatar ao administrador. (Deve escrever um valor valido para FREQUENCY no produto)</b></div><br><a style="color: black;" href="/index.php?controller=Order"><div style="padding: 10px 20px; margin-top: 30px; cursor: pointer; display: inline-block; background-color: #e8e8e8; border-radius: 20px;"><b>Corrigir</b></div></div></div>');
            die();
        }
        ...
        if ($expiration_final2 == '1 mês') {
            ...
            $final_expdate = '2035-12-12 15:30';
        }
        ...
        $body = [
            ...
            "start_time"    => gmdate('Y-m-d H:i', strtotime("1 month")),  //documentacion dice que es opcional y required al mismo tiempo, marca cuando empieza a cobrar
