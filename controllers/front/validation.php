...
if($type_ep==1){
    ...
    if(isset($_POST['guardar-metodo']) && $_POST['guardar-metodo']){
            ...
            $body = [
                ...
                "method" => "mb",
                "type" => $type_pago,
                "min_value" => floatval(Configuration::get('EASYPAY_MIN_MB')), //Precio minimo que puede pagar el cliente
                "max_value" => floatval(Configuration::get('EASYPAY_MAX_MB')), //Precio maximo que puede pagar el cliente
