...
$is_frequent=0;
        if(Tools::getValue('guardar-metodo') && Tools::getValue('guardar-metodo')){
            ...
            $body = [
                "key" => ''.$cart->id.'',
                "method" => "dd",
                "min_value" => floatval(Configuration::get('EASYPAY_MIN_DD')), //Precio minimo que puede pagar el cliente
                "max_value" => floatval(Configuration::get('EASYPAY_MAX_DD')), //Precio maximo que puede pagar el cliente
